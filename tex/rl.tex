...
Funkciju vrednosti stanja i funkciju vrednosti akcije u stanju metodima linearnog programiranja. Jedan od primera je traženje $v_*$. Na osnovu jednakosti \eqref{eq:bel_v_opt} može se postaviti skup uslova:
\begin{equation}
...
Međutim, nekada je broj stanja toliko veliki da ni jedan od ova dva pristupa nije izvodljiv.
